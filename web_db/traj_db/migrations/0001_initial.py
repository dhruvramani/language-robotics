    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('episode_type', models.CharField(choices=[('EPISODE_ROBOT_IMITATED', 'Script Generated by Imitation of Play-Data'), ('EPISODE_ROBOT_PLAY', 'Human Demonstration: Play-Data'), ('EPISODE_ROBOT_EXPERT', 'Human Demonstration: Expert, Task Specific'), ('EPISODE_ROBOT_POLICY', 'Collected by Task Specific Policy'), ('EPISODE_ROBOT_EXPLORED', 'Generated by (Random) Exploration')], default='EPISODE_ROBOT_PLAY', max_length=30)),
